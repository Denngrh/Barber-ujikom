...
$pagedes=$_POST['pagedes'];
    ...
    $query=mysqli_query($conn,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='location'");
    if ($query) {
      header("Location: location.php?info=berhasil di update");
  }
  else
    {
      header("Location: location.php?info=ada kesalahan");
    }
}
    ?>
<!DOCTYPE html>
