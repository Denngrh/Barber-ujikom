          ...
          if(isset($_POST['submit']))
            {
              ...
              $cost=$_POST['cost'];
           $eid=$_GET['editid']; 
              $query=mysqli_query($conn, "update  tblservices set ServiceName='$sername',ServiceDescription='$serdesc',Cost='$cost' where ID='$eid' ");
              if ($query) {
              echo "<script>alert('Service has been Updated.');
    ...
    <section class="section">
      <div class="row">
        ...
        <form method="post">
              ...
              ?> 
                             <div class="form-group"> <label for="exampleInputEmail1">Service Name</label> <input type="text" class="form-control mt-1" id="sername" name="sername" placeholder="Service Name" value="<?php  echo $row['ServiceName'];?>" required="true"> </div>
                             <div class="form-group mt-2"> <label for="exampleInputEmail1">Service Description</label> <textarea type="text" class="form-control mt-1" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"><?php  echo $row['ServiceDescription'];?></textarea> </div>
                             <div class="form-group mt-2"> <label for="exampleInputPassword1">Cost</label> <input type="text" id="cost" name="cost" class="form-control mt-1" placeholder="Cost" value="<?php  echo $row['Cost'];?>" required="true"> </div>
                             <div class="form-group"> <label for="exampleInputPassword1">Image</label>  <img src="assets/img/<?php echo $row['Image']?>" width="120" class="mt-3">
                             <a  href="update-img.php?lid=<?php echo $row['ID'];?>"class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                             <a>Update Image</a> 
                            </div>
                             <?php } ?>
