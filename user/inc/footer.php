      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-2 mb-3">
            ...
            <li class="pb-2"><a href="#invoices" class="text-muted text-decoration-none">Invoice</a></li>
            <li class="pb-2"><a href="#profile" class="text-muted text-decoration-none">profile</a></li> 
            </ul>
          </div>
          <div class="col-md-2 mb-3">
            <h6 class="fw-bold">Beberapa tautan</h6>
            <ul class="list-group list-unstyled">
              <li class="pb-2"><a href="404.php" class="text-muted text-decoration-none">Cookie Police</a></li>
              <li class="pb-2"><a href="404.php" class="text-muted text-decoration-none">Support</a></li>
            </ul>
          </div>
          <div class="col-md-2">
